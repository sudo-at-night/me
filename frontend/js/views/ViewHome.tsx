        ...
        return (
            <div>
                ...
                <div className="c-bio u-container u-quote-block" data-animate="bio">
                    I started programming in 2015. I created a social network for car enthusiasts and quickly
                    fell in love with creating websites and applications people can enjoy over the internet.
                    Since then I've jumped at every opportunity to learn about all the things that comprise a
                    sound experience for the end-user, but also for developers.
                    <br/>
                    <br/>
                    While I'm focused on the front-end, I also keep delving into topics of <strong>Continuous
                    Integration and Delivery</strong>, <strong>Infrastructure as Code</strong>,
                    <strong> containerization</strong> and others alike. I'd rather focus on the business logic
                    problems, automating everything that can be safely automated.
                </div>
                <main>
                    <Listings/>
                </main>
